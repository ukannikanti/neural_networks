...
def parse_args(extra_args_provider=None, ignore_unknown_args=False):
    """Parse all arguments."""
    parser = argparse.ArgumentParser(description='LM Arguments', allow_abbrev=False)
    ...
    if args.yaml_cfg is not None:
        from config.yaml_arguments import load_yaml
...
def load_retro_config(retro_project_dir):
    ...
    # Retro config path.
    retro_config_path = get_config_path(retro_project_dir)
...
def load_retro_args(args):
    ...
    data_dir = get_gpt_data_dir(args.retro_project_dir)
