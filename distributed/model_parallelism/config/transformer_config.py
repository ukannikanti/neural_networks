...
from utils.utils import init_method_normal, scaled_init_method_normal
...
class TransformerConfig(ModelParallelConfig):
    ...
    layernorm_add_bias: bool = True
    """Add bias for any LayerNorm operations."""

    layernorm_device = torch.device("cuda")
    """Add bias for any LayerNorm operations."""

    layernorm_dtype = torch.float
    """the desired data type of returned tensor for LayerNorm"""
